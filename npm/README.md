...
| 技能 | 描述 | 典型任务 |
|------|------|---------|
| [逆向工程智能体](https://github.com/ice-a/spider-cli/blob/master/skills/reverse-engineering/SKILL.md) | 端到端逆向流程 | Web/App 签名破解 |
| [JS 分析智能体](https://github.com/ice-a/spider-cli/blob/master/skills/js-analysis/SKILL.md) | 深度 JS 代码分析 | 反混淆 / 算法定位 |
| [加密工具智能体](https://github.com/ice-a/spider-cli/blob/master/skills/crypto-toolkit/SKILL.md) | 密码学验证破解 | 哈希识别 / 签名验证 |
| [流量分析智能体](https://github.com/ice-a/spider-cli/blob/master/skills/traffic-analysis/SKILL.md) | 流量捕获分析 | HAR 解析 / 代理抓包 |
| [智能体编排](https://github.com/ice-a/spider-cli/blob/master/skills/agent-orchestration/SKILL.md) | 多智能体协作 | 任务分解 / 并行执行 |
...
- [技能系统完整文档](https://github.com/ice-a/spider-cli/blob/master/skills/README.md)
- [MCP 服务器配置](https://github.com/ice-a/spider-cli/blob/master/MCP_SETUP.md)
- [逆向工程智能体](https://github.com/ice-a/spider-cli/blob/master/skills/reverse-engineering/SKILL.md)
- [智能体编排指南](https://github.com/ice-a/spider-cli/blob/master/skills/agent-orchestration/SKILL.md)
